...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    if (!$password || !$username || !$email || !$Age){
...
<body>
        ...
        <div class="navbar" id="navbar_menu">
            <ul class="navbar__ul">
                ...
                <li class="navbar__li navbar__dropdown ">
                    <a class="navbar__a display-none">Sản phẩm <i class="fa-solid fa-chevron-down"></i></i></a>
                    <ul id="dropdown-content" class="display-none">
                        <li class="dropdown-content__li"><a id="drop_content_a" class="navbar__a"
                                href="./SanPham.php#hoaqua" class="dropdown-content__a">Hoa qua</a></li>
                        <li class="dropdown-content__li"><a class="navbar__a" href="./SanPham.php#thucphamtuoisong"
                                class="dropdown-content__a">Thực phẩm tươi sống</a></li>
                        <li class="dropdown-content__li"><a class="navbar__a" href="./SanPham.php#raucu"
                                class="dropdown-content__a">Rau củ</a></li>
                    </ul>
                </li>
            </ul>
            <div class="header__search-user" action="">
                ...
                <div class="header--user">
                    ...
                    <a href="./GioHang.php" class="shopping__cart header--user--btn shop--btn">
    ...
    <main class="main">
        <div class="banner">
            <div class="banner-img">
                ...
                <div class="tieude">
                    <p class="tieude-trang"> Tài Khoản </p>
                </div>
            </div>
        </div>
        <div class="login-main">
            <div class="login-tieude">
                <h3> Đăng Ký</h3>
            </div>
            ...
            <div class="login-form">
                <form action="" method="POST" class="form-account">
                    <div class="form-gr">
                        ...
                        <input type="text" name="username" id="dk_inputname" placeholder="Họ và Tên..."><br>
                        <small id="messName"></small>
                    </div>
                    <div class="form-gr">
                        <label for="">Email:</label>
                        <input type="email" name="email" id="dk_inputemail" placeholder="Email..."><br>
                        <small id="messEmail"></small>
                    </div>
                    <div class="form-gr">
                        <label for="">Mật Khẩu:</label>
                        <input type="password" name="password" id="dk_inputpass" placeholder="Mật Khẩu..."><br>
                        <small id="messPass"></small>
                    </div>
                    <div class="form-gr">
                        <label for="">Age</label>
                        <input type="text" name="Age" id="dk_inputpass2" placeholder="Age"><br>
                        <small id="messPass2"></small>
                    </div>
                    <div class="form-button">
                        <button id="btn_dangky" type="submit" class="button-submit all-btn"> Đăng ký
                        </button>
                        
                    </div>
                </form>
                <a href="DangNhap.php" class="tag-dangky "> Đăng Nhập </a>
            </div>
        </div>
    </main>
    <!-- end main -->
    ...
    <script src="./asset/FormDangKy.js"></script>
