...
$connect = mysqli_connect ('localhost', 'root', '', 'tutorial') or die ('Không thể kết nối tới database');
...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
    ...
    }elseif($row["role"]=="1")
    {
        ...
        echo "username or password inconrrect";
   }
   }
}
?>
        ...
        <div class="login-main">
            ...
            <div class="login-form">
                <form action="" method="POST" class="form-account">
                    ...
                    <button id="btn_dangky" type="submit" class="button-submit all-btn"> Đăng Nhập
                        </button>
                    </div>
                    
                </form>
                <a href="DangKy.php" class="tag-dangky"> Đăng Ký </a>
            </div>
        </div>
    </main>
    <!-- end main -->
